...
| **Empresas / Contatos** | **EM TRANSIÇÃO** — CRM operacional próprio (Rio X7 AI Agency OS), ainda não implementado; † fonte anterior: CRM Notion (`RIO X7 — Pipeline Comercial`) | SDR, Raio-X, CRM AI (quando existir) | Humano (ou sugestão de IA sob aprovação) | Breno/Closer |
...
| **CRM** (estágio/Status/Temperatura) | **EM TRANSIÇÃO** — CRM operacional próprio (Rio X7 AI Agency OS) é a fonte de verdade decidida (0012), ainda não implementado; † fonte anterior: Notion `Pipeline Comercial` | Quase todos os especialistas | Humano (testado uma vez sob autorização — Passo 1.7; escrita real no CRM operacional é FUTURO, etapas CRM-SERVICE/CRM-API) | Breno/Closer |
...
| **Clientes** (Status = WON) | **EM TRANSIÇÃO** — subconjunto por Status do CRM operacional próprio, ainda não implementado; † fonte anterior: mesmo CRM Notion | Onboarding/Customer Success (futuros) | Humano | Humano |
