...
| **Empresas / Contatos** | CRM Notion (`RIO X7 — Pipeline Comercial`) | SDR, Raio-X, CRM AI (quando existir) | Humano (ou sugestão de IA sob aprovação) | Breno/Closer |
...
| **CRM** (estágio/Status/Temperatura) | Notion `Pipeline Comercial` | Quase todos os especialistas | Humano (testado uma vez sob autorização — Passo 1.7) | Breno/Closer |
...
| **Clientes** (Status = WON) | Mesmo CRM Notion, subconjunto por Status | Onboarding/Customer Success (futuros) | Humano | Humano |
