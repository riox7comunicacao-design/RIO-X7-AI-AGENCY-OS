...
- [docs/decisions/](./docs/decisions/) — decisões arquiteturais (0001–0022); as mais recentes: 0012 (CRM próprio), 0013 (domínio), 0014 (Service), 0015 (API), 0016 (promoção Approval Queue → CRM)
